...
export default {
  ...
  methods: {
    async carregarCategorias() {
      const res = await fetch('http://34.51.158.117:3000/api/categorias');
      this.categorias = await res.json();
    },

    async carregarTipos() {
      const res = await fetch('http://34.51.158.117:3000/api/tipos');
      this.tipos = await res.json();
    },

    async adicionarCategoria() {
      const url = this.editandoCategoriaId
        ? `http://34.51.158.117:3000/api/categorias/${this.editandoCategoriaId}`
        : 'http://34.51.158.117:3000/api/categorias';
    ...
    async apagarCategoria(id) {
      if (confirm('Deseja realmente apagar esta categoria?')) {
        try {
          const res = await fetch(`http://34.51.158.117:3000/api/categorias/${id}`, { method: 'DELETE' });
    ...
    async adicionarTipo() {
      const url = this.editandoTipoId
        ? `http://34.51.158.117:3000/api/tipos/${this.editandoTipoId}`
        : 'http://34.51.158.117:3000/api/tipos';
  ...
  finalizarCompra() {
    ...
    async apagarTipo(id) {
      if (confirm('Deseja realmente apagar este tipo?')) {
        try {
          const res = await fetch(`http://34.51.158.117:3000/api/tipos/${id}`, { method: 'DELETE' });
